...
function Header() {
  ...
  return (
    <header className="container mx-auto md:flex justify-between min-w-full" style={{ backgroundColor: '#23153C', }}>
      <div className="flex justify-between items-center py-2 ">
        <NavLink to="/">
          <img className="w-14 " src={logos.logogradient} alt="anas akil" />
        </NavLink>
